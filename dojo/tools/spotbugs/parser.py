        ...
        for pattern in root.findall("BugPattern"):
            ...
            for line in html_text.splitlines():
                ...
                if "Reference" in line:
                    break
                # Add a string before the code indicating that it's just an
                # example, NOT the actual scanned code
                if (
                    ("Vulnerable Code:" in line)
        ...
        for bug in root.findall("BugInstance"):
            ...
            if source_extract is not None:
                ...
                if (
                    ...
                    and source_extract.get("start").isdigit()
                ):
